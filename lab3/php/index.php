    ...
    <section class="examples-section" id="examples">
      ...
      <div class="examples wrapper1370">
        <div class="example-img">
          <img src="../img/image 18.png" alt="cappadocia">
          <div class="example-text">
            <p class="text">1. Сайт компании, которая организовывает туры в Cappadocia</p>
            <p class="text status-ready">Готово</p>
            <a class="example-portfolio-link" href="http://web1.std-2131.ist.mospolytech.ru/html/">Перейти на сайт</a>
          </div>
        </div>
        <div class="example-img">
          <img src="../img/image 19.png" alt="polyweb">
          <div class="example-text">
            <p class="text">2. Сайт digital агенства организованного из студентов московского политеха</p>
            <p class="text status-almost">Готово на 60%</p>
            <a class="example-portfolio-link" href="https://polywebagency.ru">Перейти на сайт</a>
          </div>
        </div>
        <div class="example-img">
          <img src="../img/image 20.png" alt="social design">
          <div class="example-text">
            <p class="text">3. Дизайн социальных сетей клининговой фирмы</p>
            <p class="text status-ready">Готово</p>
            <a class="example-portfolio-link"
              href="https://www.figma.com/file/8QxGGXQKmvoHftTqeJisWw/%D0%94%D0%B7-%D0%BC%D0%BE%D0%B4%D1%83%D0%BB%D1%8C-4?node-id=0%3A1&t=VPNWgd9hoe0lLQIU-1">Перейти
              на сайт</a>
          </div>
        </div>
        <div class="example-img">
          <img src="../img/Rectangle 37506.png" alt="ad design">
          <div class="example-text">
            <p class="text">4. Дизайн рекламы телевизоров</p>
            <p class="text status-ready">Готово</p>
            <a class="example-portfolio-link"
              href="https://www.figma.com/file/O9NJgY9mdmpm7K4w0n5AnA/%D0%A2%D1%80%D0%B5%D1%82%D0%B8%D0%B9-%D0%B1%D0%B0%D0%BD%D0%B5%D1%80?node-id=0%3A1&t=V7Ek5vaUh4JbVj1E-1">Перейти
              на сайт</a>
          </div>
        </div>
      </div>
